 ...
 *
 * That means this hook is a browser hook. But React code could be generated
 * from the server without the Window API.
 *
 ...
 * useLayoutEffect should only be used in components that render exclusively on
 * the client. See https://reactjs.org/link/uselayouteffect-ssr for common fixes.
 *
